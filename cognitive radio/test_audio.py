...
data = np.random.randint(0,16,size = 40)
...
signal = modulateFSK(data, 440.0, 4200.0, 32, 44100.0, .1)
...
signal = streamAndRecord(signal, 5)
...
rec_data = demodulateFSK(cropped, 440.0, 4200.0, 32, 44100.0/5, 0.1)
